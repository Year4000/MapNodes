...
public class BarAPI {
    ...
    private void handleTeleport(final Player player, final Location loc) {
        ...
        Bukkit.getScheduler().runTaskLater(MapNodes.getInst(), new Runnable() {
    ...
    public static void setMessage(final Player player, String message, int seconds) {
        ...
        timers.put(player.getName(), Bukkit.getScheduler().runTaskTimer(MapNodes.getInst(), new BukkitRunnable() {
