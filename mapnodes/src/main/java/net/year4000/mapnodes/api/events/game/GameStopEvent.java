...
public class GameStopEvent extends EventPlus {
    ...
    public String toString() {
        return "net.year4000.mapnodes.api.events.game.GameStopEvent(game=" + this.getGame() + ")";
    }

    public boolean equals(Object o) {
        if (o == this) return true;
        if (!(o instanceof GameStopEvent)) return false;
        final GameStopEvent other = (GameStopEvent) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof GameStopEvent;
    }
}
