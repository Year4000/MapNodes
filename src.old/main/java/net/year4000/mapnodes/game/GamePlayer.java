...
public class GamePlayer {
    ...
    public static void join(final Player player) {
        ...
        if ((!gm.getMap().isElimination() && !GameStage.isPlaying()) || !GameStage.isEndGame()){
        ...
        Bukkit.getScheduler().runTaskLater(MapNodesPlugin.getInst(), () ->
    ...
    public void start() {
        ...
        Location spawn = getTeam().getSafeRandomSpawn();
        spawn.getChunk().load();
