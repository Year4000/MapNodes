...
import net.year4000.mapnodes.utils.nms.FakeDragon;
...
public class BarAPI {
    ...
    private void handleTeleport(final Player player, final Location loc) {
        ...
        Bukkit.getScheduler().runTaskLater(MapNodesPlugin.getInst(), new Runnable() {
    ...
    public static void setMessage(final Player player, String message, int seconds) {
        ...
        timers.put(player.getName(), Bukkit.getScheduler().runTaskTimer(MapNodesPlugin.getInst(), new BukkitRunnable() {
