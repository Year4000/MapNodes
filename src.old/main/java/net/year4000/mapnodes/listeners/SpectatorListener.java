...
public class SpectatorListener implements Listener {
    ...
    public void onInteract(EntityInteractEvent event) {
        ...
        GameManager gm = WorldManager.get().getCurrentGame();
        NodePlayer gPlayer = gm.getPlayer((org.bukkit.entity.Player)event.getEntity());
    ...
    public void onIvnInteract(InventoryClickEvent event) {
        ...
        GameManager gm = WorldManager.get().getCurrentGame();
        NodePlayer gPlayer = gm.getPlayer((org.bukkit.entity.Player)event.getWhoClicked());
    ...
    public void onDamage(EntityDamageByEntityEvent event) {
        ...
        GameManager gm = WorldManager.get().getCurrentGame();
        NodePlayer gPlayer = gm.getPlayer((org.bukkit.entity.Player)event.getDamager());
